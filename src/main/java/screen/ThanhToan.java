...
//        }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 341, 169, -1));
        jPanel2.add(txtSDT, new org.netbeans.lib.awtextra.AbsoluteConstraints(181, 338, 340, -1));
        ...
        jButton2.setText("THANH TOÁN MỚI");
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 378, 637, -1));
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 493, 164, -1));
        ...
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(188, 492, 455, -1));
        ...
        jPanel4.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 217, -1));
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 10, -1, -1));
        ...
        jPanel4.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 41, 530, 330));
        ...
        /**
         * Load voucher from invoice (call after cart is loaded and tongTien calculated)
         */
        ...
        private void taoHoaDonMoiFromButton() {
                try {
                        ...
                        if (demHoaDonChuaThanhToan() >= 10) {
                                JOptionPane.showMessageDialog(this,
                                                "Đã đạt giới hạn tối đa 10 hóa đơn chưa thanh toán!\n" +
